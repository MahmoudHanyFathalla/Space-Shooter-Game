...
class Game:
    def __init__(self):
        ...
        self.helper = Helper(700, 100)  # Instantiate the Helper object
    ...
    def update(self):
        if self.player:  
            ...
            self.helper.update(self.enemy_bullets)  # Update the helper with enemy bullets
    ...
    def render(self, screen):
        ...
        self.helper.render(screen)  # Render the helper along with other game entities
